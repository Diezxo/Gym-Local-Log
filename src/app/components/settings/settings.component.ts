...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-[var(--color-bg-primary)] px-6 pt-12 pb-36 flex flex-col gap-4">
      ...
      <!-- Saved confirmation -->
      @if (showSaved()) {
        <div class="px-5 py-3 rounded-xl bg-emerald-500/15 border border-emerald-500/30 text-emerald-400 text-sm text-center font-bold animate-fade-in ">
  ...
  changeDetection: ChangeDetectionStrategy.OnPush
        ...
        <!-- Language -->
        <div class="bg-[var(--color-bg-card)] rounded-2xl p-4 border border-[var(--color-border)] transition-all duration-300 ">
        ...
        <div class="bg-[var(--color-bg-card)] rounded-2xl p-4 border border-[var(--color-border)] transition-all duration-300  mb-8">
          ...
          @if (fsConnected()) {
            <div class="px-5 py-4 rounded-xl bg-emerald-500/15 border border-emerald-500/30 flex items-center justify-center gap-3 ">
            ...
            <button
              ...
              class="btn-primary min-h-[48px] w-full text-lg font-bold flex items-center justify-center gap-3"
            >
